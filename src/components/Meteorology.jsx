...
function Meteorology(props) {
    ...
    useEffect(() => {
        ...
        fetch(`https://dataservice.accuweather.com/forecasts/v1/daily/5day/${k}?apikey=${process.env.REACT_APP_SECRET_KEY}&language=en-US&details=false&metric=true`, {mode: 'no-cors', method: "GET"})
        .then(res => res.json())
        .then(
            (result) => {
                // setCity('');
